...
class cWGAN_Generator_Gray_128(nn.Module):
    def __init__(self, z_dim, channels_img, features_g, num_classes, img_size, embed_size, dropout_prob = 0.5) -> None:
        ...
        self.generator = nn.Sequential(
            ...
            self._block(features_g*2,features_g, 4, 2, 1), # N x  features_g x 64x64
            nn.ConvTranspose2d(features_g, channels_img, kernel_size=4, stride=2, padding=1), # N x channels_img x 128x128
            nn.Tanh(), # [-1, 1]       
        )
